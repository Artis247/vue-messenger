    ...
    <div class="other-message-body">
        ...
        <div class="message-content">
            <template v-if="message.type == 'image'">
                <p class="message-username-image">{{this.$store.state.participants[0].name}}</p>
            ...
            <template v-else>
                <div class="message-text" :style="{background: colors.message.others.bg, color: colors.message.others.text}">
                    <p class="message-username">{{this.$store.state.participants[0].name}}</p>
