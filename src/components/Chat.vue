<template>
    <div class="quick-chat-container"
        ...
        <Header v-if="displayHeader" 
                :colors="colors" :border-style="borderStyle" 
                :hide-close-button="hideCloseButton" :close-button-icon-size="closeButtonIconSize" 
                @onClose="onClose()" @update="update()">
            <template #header>
                <slot name="header"></slot>
            </template>
        </Header>
        <ListOfChats v-if="!visible" 
                     :participants="participants"
                     @list="list"/>
        <MessageDisplay v-if="visible"
                        :colors="colors" :async-mode="asyncMode" :load-more-messages="loadMoreMessages"
...
<script>
    ...
    import ListOfChats from './ListOfChats.vue'
    ...
    export default {
        ...
        methods: {
            ...
            onClose: function(){
                this.$store.state.participants=this.$store.state.contacts;
                this.visible=!this.visible;
                this.$emit("onClose");
            },
            update: function(){
                console.log("STORE from CHAT",this.$store.state)
                this.$emit("update");
            },
            onType: function(e){
                this.$emit("onType", e)
